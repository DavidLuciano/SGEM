...
##    def get_lshape_a1(self):
##        self.file_a1 = tkFileDialog.askopenfile()
##        self.broadcast(self.get_lshape_a1_button)
##
##    def get_lshape_b1(self):
##        self.file_b1 = tkFileDialog.askopenfile()
##        self.broadcast(self.get_lshape_b1_button)
##
##    def get_lshape_c1(self):
##        self.broadcast(self.get_lshape_c1_button)
##
##    def get_lshape_a2(self):
##        self.file_a2 = tkFileDialog.askopenfile()
##        self.broadcast(self.get_lshape_a2_button)
##
##    def get_lshape_b2(self):
##        self.file_b2 = tkFileDialog.askopenfile()
##        self.broadcast(self.get_lshape_b2_button)
##
##    def get_lshape_c2(self):
##        self.broadcast(self.get_lshape_c2_button)
##
##    def get_lshape_a3(self):
##        self.file_a3 = tkFileDialog.askopenfile()
##        self.broadcast(self.get_lshape_a1_button)
##
##    def get_lshape_b3(self):
##        self.file_b3 = tkFileDialog.askopenfile()
##        self.broadcast(self.get_lshape_b3_button)
##
##    def get_lshape_c3(self):
##        self.broadcast(self.get_lshape_c3_button)
##
##-----------
##    def go(self):
##        
